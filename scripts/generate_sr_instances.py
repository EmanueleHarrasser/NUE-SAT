...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--clauses", type=int, default=1200)
    parser.add_argument("--mode", choices=["ratio", "fixed"], default="ratio")
    parser.add_argument("--ratio-min", type=float, default=2)
    parser.add_argument("--ratio-max", type=float, default=4)
    parser.add_argument("--vars-min", type=int, default=150)
    parser.add_argument("--vars-max", type=int, default=300)
